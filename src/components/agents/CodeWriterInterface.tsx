  ...
  return (
    <BaseAgentInterface agent={agent}>
      <div className="flex flex-col h-full overflow-hidden">
        {/* Ensure content area has limited height with scrolling */}
        <div className="flex-grow grid grid-cols-2 gap-4 max-h-[65vh]">
          <div className="overflow-hidden flex flex-col">
            <label className="block text-sm font-medium text-gray-300 mb-1">Specifications</label>
            <div className="relative flex-grow">
              <textarea 
                className="absolute inset-0 w-full h-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white font-mono overflow-auto"
          ...
          <div className="overflow-hidden flex flex-col">
            ...
            <div className="relative flex-grow">
              <div className="absolute inset-0 w-full h-full bg-gray-700 border border-gray-600 rounded p-2 overflow-auto">
                {agent.currentOutput ? (
        ...
        <div className="mt-4 flex justify-between items-center sticky bottom-0 bg-gray-900 pt-2">
